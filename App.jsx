  ...
  return (
    <div style={{display:"flex",alignItems:"center",gap:8}}>
      ...
      <svg height={size*.75} viewBox="0 0 94 24">
        ...
        <text x="105" y="20" fontSize="22" fontWeight="800" fontFamily="Syne,sans-serif" fill={gic}>gic</text>
...
═══════════════════════════════════════════ */
function Footer({ nav }) {
  const prod=[{id:"features",l:"Features"},{id:"generator",l:"Generator"},{id:"pricing",l:"Pricing"},{id:"testimonials",l:"Testimonials"}];
